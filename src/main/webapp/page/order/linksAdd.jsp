...
<body class="childrenBody">
	<form class="linksAdd" action=""	method="post">
		<div class="layui-form-item">
			<label class="layui-form-label">一级分类名称</label>
			<div class="layui-input-block">
				<select name="stair" id="sd"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="uname" id="sb" >
			</div>
		</div>
		<div class="layui-form-item">
			<input type="button" id="sub"  value="添加"class="layui-btn layui-block"/>
		</div>
	</form>
		...
		$("#sub").click(function(){
			 window.close();
			  $.ajax({
				   url:_url,
				   type:"POST",
				   data:{"oper":"info","stair": $("#sd").val(),"second": $("#sc").val(),"uname": $("#sb").val()},
				   dataType:"text",
